...
db_path = os.path.join(BASE_DIR, "../countries_locations.db")
...
def get_ukraine_map(request):
    ...
    ukraine_map = folium.Map(location=[49.842957, 24.031111], zoom_start=14, prefer_canvas=True)
...
def crypto_usage(request):
    return render(request, 'crypto_usage.html')